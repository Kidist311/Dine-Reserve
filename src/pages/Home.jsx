...
{/* Our articles */}
<div className="w-full max-w-[1300px] min-h-screen bg-orange-50 py-10">
  {/* Header section */}
  ...
  {/* Articles container - Fixed layout */}
  <div className="flex flex-col md:flex-row gap-6 px-6 justify-center items-start">
    ...
    <div className="bg-white border border-gray-300 rounded-2xl w-full md:w-[590px] md:h-[800px] flex flex-col justify-start items-start">
      ...
      <div className="p-6 mt-5">
        ...
        <h2 className="font-bold text-4xl mt-2 text-left mb-2">Lorem ipsum dolor sit amet consectetur</h2>
    ...
    {/* Grid of 4 articles - Right side */}
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full md:w-auto">
      {/* Card 1 */}
      <div className="bg-white border border-gray-300 rounded-2xl w-full md:w-[280px] md:h-[390px] flex flex-col justify-start items-start">
